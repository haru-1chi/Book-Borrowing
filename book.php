...
<div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 0px;">
        <div class="container text-center py-5">
            ...
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"><a class="text-white" href="">เพิ่มหนังสือใหม่</a></p>
	...
	<!-- Page Content -->
		...
		<div class="jumbotron">
			...
			<div class="row">
				...
				<div class="col-lg-6 ">
					<h2 class="display-5 text-center">เพิ่มหนังสือใหม่</h2>
					<br>
					<form class="container" action="save_book.php" method="post" id="needs-validation" novalidate enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-12 mb-3">
								...
								<input type="text" class="form-control" id="validationCustom03" placeholder="รหัสหนังสือ" name="book_code" required>
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								...
								<input type="text" class="form-control" id="validationCustom04" placeholder="ชื่อหนังสือ" name="book_name" required>
								<div class="invalid-feedback">
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								...
								<textarea name="book_user" class="form-control" id="validationCustom05" placeholder="ผู้แต่ง"  rows="4"></textarea>
								<div class="invalid-feedback">
									กรุณาระบุผู้แต่ง.
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								...
								<input type="text" class="form-control" id="validationCustom06" placeholder="ชื่อหมวดหมู่" name="book_category" >
								<div class="invalid-feedback">
